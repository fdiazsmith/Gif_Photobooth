...
public GifMaker(PApplet parent) {
  ...
  public GifEncoder initEncoder(String filename) { //made this public!1!!!!
   ...
   */
  public void setTransparent(int color_) {
    setTransparent((int) parent.red(color_), (int) parent.green(color_),
        (int) parent.blue(color_));
  }
